...
function initModal() {
    ...
    t.forEach((e) => {
        e.addEventListener("click", (t) => {
            ...
            const r = a.classList.contains("open__hashtags");
            n(), r || (a.classList.add("open__hashtags"), (e.style.opacity = "1"));
        });
    });
    let a = 0,
        r = 0,
    ...
    document.addEventListener("touchstart", (e) => {
        ...
        t && ((a = e.touches[0].clientX), (c = !0), (t.dataset.isSwiping = "true"));
    }),
        document.addEventListener("touchmove", (t) => {
            const o = document.querySelector('.modal.open[data-is-swiping="true"]');
            o && c && ((r = t.touches[0].clientX), a - r > 150 && (o.classList.remove("open"), e(), n(), (c = !1), delete o.dataset.isSwiping));
        }),
        document.addEventListener("touchend", () => {
            const e = document.querySelector('.modal.open[data-is-swiping="true"]');
            e && ((c = !1), delete e.dataset.isSwiping);
        });
}
function initCopy() {
